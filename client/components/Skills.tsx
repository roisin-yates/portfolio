    ...
    <div className="mx-10 mt-36 flex">
      <div className="mx-10 w-1/2 bg-slate-50 p-6">
        ...
        <p className="font-Roboto text-xl">
          ...
          intuitive design. I am passionate about creating user interfaces that
          not only look great, but also function flawlessly.
        </p>
        <p className="mt-24 font-Roboto text-xl">
      ...
      <div className="mx-10 flex w-1/2 flex-wrap justify-around">
        ...
        <img
          ...
          className="m-4 h-24"
        />
        <img src="./img/Bulma-Logo.png" alt="Bulma logo" className="m-4 h-24" />
        <img
